"""
#exonware/xwnode/tests/1.unit/nodes_tests/strategies_tests/test_red_black_tree_strategy.py
Comprehensive tests for RedBlackTreeStrategy.
Tests cover:
- Interface compliance (iNodeStrategy)
- Core operations (put, get, delete)
- Red-black tree balancing (color rules)
- Tree rotations
- Range queries
- Iterator protocol
...
def empty_tree():
    """Create empty red-black tree strategy."""
    return RedBlackTreeStrategy()
@pytest.fixture

def simple_tree():
    """Create red-black tree with simple data."""
    tree = RedBlackTreeStrategy()
...
def large_tree():
    """Create red-black tree with enough data to test balancing."""
    tree = RedBlackTreeStrategy()
    for i in range(20):
...
class TestRedBlackTreeStrategyInterface:
    """Test RedBlackTreeStrategy implements iNodeStrategy interface correctly."""
...
class TestRedBlackTreeStrategyBalancing:
    """Test red-black tree balancing and color rules."""

    def test_tree_remains_balanced(self, large_tree):
        """Test tree maintains balance after many insertions."""
        # Red-black tree should maintain O(log n) height
...
class TestRedBlackTreeStrategyCore:
    """Test core RedBlackTreeStrategy functionality."""
...
class TestRedBlackTreeStrategyIterators:
...
class TestRedBlackTreeStrategyEdgeCases:
...
class TestRedBlackTreeStrategyPerformance:
    ...
    def test_large_dataset_operations(self):
        ...
        # All should be accessible (guaranteed O(log n))
        for i in range(100):
