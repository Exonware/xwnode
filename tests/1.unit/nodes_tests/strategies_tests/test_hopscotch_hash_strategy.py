"""
#exonware/xwnode/tests/1.unit/nodes_tests/strategies_tests/test_hopscotch_hash_strategy.py

Comprehensive tests for HopscotchHashStrategy.

Tests cover:
- Interface compliance (iNodeStrategy)
- Core operations (put, get, delete)
- Hopscotch hashing with bounded neighborhood
- Neighborhood search
- Iterator protocol
...
from exonware.xwnode.nodes.strategies.hopscotch_hash import HopscotchHashStrategy
...
@pytest.fixture
def empty_hash():
    """Create empty hopscotch hash strategy."""
    return HopscotchHashStrategy()


@pytest.fixture
def simple_hash():
    """Create hopscotch hash with simple data."""
    hash_strategy = HopscotchHashStrategy()
...
class TestHopscotchHashStrategyInterface:
    """Test HopscotchHashStrategy implements iNodeStrategy interface correctly."""
...
@pytest.mark.xwnode_unit
@pytest.mark.xwnode_node_strategy
class TestHopscotchHashStrategyCore:
    """Test core HopscotchHashStrategy functionality."""
...
@pytest.mark.xwnode_unit
@pytest.mark.xwnode_node_strategy
class TestHopscotchHashStrategyEdgeCases:
