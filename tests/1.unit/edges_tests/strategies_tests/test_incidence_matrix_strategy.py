"""
#exonware/xwnode/tests/1.unit/edges_tests/strategies_tests/test_incidence_matrix_strategy.py
Comprehensive tests for IncidenceMatrixStrategy (edge strategy).
Tests cover:
...
def empty_strategy():
    """Create empty incidence matrix strategy."""
    return IncidenceMatrixStrategy()
@pytest.fixture

def simple_strategy():
    """Create incidence matrix with simple graph."""
...
class TestIncidenceMatrixStrategyInterface:
    """Test IncidenceMatrixStrategy implements iEdgeStrategy interface correctly."""
...
class TestIncidenceMatrixStrategyCore:
    """Test core IncidenceMatrixStrategy functionality."""
...
class TestIncidenceMatrixStrategyEdgeCases:
