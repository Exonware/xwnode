"""
#exonware/xwnode/tests/1.unit/edges_tests/strategies_tests/test_rtree_strategy.py
Comprehensive tests for RTreeStrategy (edge strategy).
Tests cover:
- Interface compliance (iEdgeStrategy)
- Core edge operations (add_edge, has_edge, delete_edge)
- Spatial queries (range queries, nearest neighbor)
...
def empty_strategy():
    """Create empty R-tree strategy."""
    return RTreeStrategy()
@pytest.fixture
...
class TestRTreeStrategyInterface:
    """Test RTreeStrategy implements iEdgeStrategy interface correctly."""
...
class TestRTreeStrategySpatial:
...
class TestRTreeStrategyCore:
    """Test core RTreeStrategy functionality."""
...
class TestRTreeStrategyEdgeCases:
