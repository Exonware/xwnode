"""
Shared utilities for xNode strategies.
...
def recursive_to_native(obj: Any) -> Any:
    ...
    This is a shared utility for converting complex objects (including xNode objects)
    to native Python types for serialization and comparison.
    """
    if hasattr(obj, 'to_native'):
        # This is an xNode, recursively convert it
...
def safe_to_native_conversion(data: Any) -> Any:
    """Safely convert data to native Python types, handling xNode objects."""
