#!/usr/bin/env python3
"""
xNode Model Tests Runner
=======================

Simple script to run xNode model tests independently.
...
def main():
    """Run the xNode model tests."""
    try:
        # Setup environment first
        project_root, src_path = setup_environment()
        
        current_dir = Path(__file__).parent
        test_file = current_dir / "test_model.py"
        
        print("🧪 Running xNode Model Tests")
        print("=" * 40)
