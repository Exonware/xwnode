#!/usr/bin/env python3
"""
xNode Core Tests Runner
======================

Simple script to run xNode core tests independently.
...
def main():
    """Run the xNode core tests."""
    try:
        # Setup environment first
        project_root, src_path = setup_environment()
        
        current_dir = Path(__file__).parent
        test_file = current_dir / "test_xnode_core.py"
        
        print("🧪 Running xNode Core Tests")
        print("=" * 40)
