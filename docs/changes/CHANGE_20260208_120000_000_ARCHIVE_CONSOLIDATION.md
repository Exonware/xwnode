# Change: Archive consolidation and value in REFs/logs

**Date:** 08-Feb-2026 12:00:00.000  
**Type:** Documentation  
**Scope:** docs/ root and _archive.

---

## Phase 1 (08-Feb-2026)

All non-standard documentation was moved from docs/ root into docs/_archive/ (per GUIDE_41_DOCS). Value from archived docs was linked from REFs and logs.
...
*Per GUIDE_41_DOCS. See [INDEX.md](../INDEX.md) and [_archive/README.md](../_archive/README.md).*
