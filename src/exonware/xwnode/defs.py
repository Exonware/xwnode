...
Note: Query-related enums (QueryMode, QueryTrait) are defined below; xwquery.defs has equivalent definitions when using xwquery.
"""
...
class QueryFormatType(Enum):
    """Query format types for strategy registration."""
    SQL = "sql"
    HIVEQL = "hiveql"
    PIG = "pig"
    CQL = "cql"
...
# Query format constants (for strategy registration)
SQL = QueryFormatType.SQL
HIVEQL = QueryFormatType.HIVEQL
PIG = QueryFormatType.PIG
CQL = QueryFormatType.CQL
N1QL = QueryFormatType.N1QL
EQL = QueryFormatType.EQL
KQL = QueryFormatType.KQL
FLUX = QueryFormatType.FLUX
DATALOG = QueryFormatType.DATALOG
GRAPHQL = QueryFormatType.GRAPHQL
SPARQL = QueryFormatType.SPARQL
GREMLIN = QueryFormatType.GREMLIN
CYPHER = QueryFormatType.CYPHER
LINQ = QueryFormatType.LINQ
JSONIQ = QueryFormatType.JSONIQ
JMESPATH = QueryFormatType.JMESPATH
XQUERY = QueryFormatType.XQUERY
XPATH = QueryFormatType.XPATH
XML_QUERY = QueryFormatType.XML_QUERY
JSON_QUERY = QueryFormatType.JSON_QUERY
# ============================================================================
# STRATEGY METADATA
# ============================================================================
...
NODE_STRATEGY_METADATA: dict[NodeMode, StrategyMetadata] = {
    NodeMode.TREE_GRAPH_HYBRID: StrategyMetadata(
        ...
        ["general purpose", "tree + graph hybrid", "broad compatibility"],
...
EDGE_STRATEGY_METADATA: dict[EdgeMode, StrategyMetadata] = {
    EdgeMode.TREE_GRAPH_BASIC: StrategyMetadata(
        ...
        ["general purpose", "lightweight graphs", "broad compatibility"],
        "balanced performance",
        "medium"
    ),
